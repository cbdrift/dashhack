...
# Get the latest source
		...
		mkdir /home/pi/cbupdate
		git clone https://github.com/cbdrift/dashhack.git /home/pi/cbupdate
		cd cbupdate
		./updatedaemons.sh
		./updateUserDashboards.sh
		fi
...
# Get the latest source
		if [ -d /home/pi/cbupdate ]; then
		echo "Updating to latest cbupdate source "
		cd /home/pi/cbupdate
		git reset --hard
		git clean -fd
		git pull
		...
		echo "Create cb update source directory and clone cb PowerTune Repo"
		mkdir /home/pi/cbupdate
		git clone https://github.com/cbdrift/dashhack.git /home/pi/cbupdate
		cd cbupdate
		./updatedaemons.sh
...
# Compile PowerTune
		cd /home/pi/building
		echo "Compiling cb PowerTune ... go grab a Coffee"
		/opt/QT5/bin/qmake /home/pi/cbupdate
		make -j4
# Check if the PowerTune executable exists in the build folder
